                ...
                <div className="flex flex-col items-center text-center space-y-8 max-w-3xl mx-auto">
                  <div className="space-y-4">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto pt-4">
                      Discover, explore, and register for exciting events in one
                      place. PulseEvents makes event management simple, intuitive,
                      and seamless.
                    </p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                  <div className="p-6 rounded-lg border bg-card text-center space-y-3">
                    ...
                    <p className="text-muted-foreground">
                      Find events that match your interests with powerful search
                  ...
                  <div className="p-6 rounded-lg border bg-card text-center space-y-3">
                    ...
                    <p className="text-muted-foreground">
                      Register for events in seconds with our streamlined
